...
- `docs/completed/005_preview_runtime_optimization.md`: Dirty/Node/Composition/Surface Cache와 Preview Runtime 기준
- `docs/completed/006_editor_draft_runtime_integration.md`: PointerMove Draft와 PointerUp Commit 경계
- `docs/completed/007_transform_origin_editing.md`: Anchor/Transform Offset와 Properties 양방향 Draft
- `docs/completed/008_canvas_engine_responsibility_refactoring.md`: Transform Composer/Controller와 Preview Render 책임
- `docs/completed/009_canvas_visual_layer_selection.md`: Direct Selection, 공용 Alpha와 outer glow 계약
