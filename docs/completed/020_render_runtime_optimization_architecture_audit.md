...
- `docs/completed/003_preview_quality_and_memory_cache.md`
- `docs/completed/004_dual_renderer_architecture.md`
- `docs/completed/005_preview_runtime_optimization.md`
- `docs/completed/006_editor_draft_runtime_integration.md`
- `docs/completed/008_canvas_engine_responsibility_refactoring.md`
- `docs/completed/009_canvas_visual_layer_selection.md`
- `docs/completed/010_transform_drag_runtime_continuity_optimization.md`
- `docs/completed/011_measured_preview_interaction_runtime_optimization.md`
- `docs/completed/017_layer_document_architecture.md`
