...
`docs/completed/017_layer_document_architecture.md`, Editor Project Owner와 Panel Engine
구조는 `docs/completed/019_editor_project_owner_panel_engine_architecture.md`가 기준이며,
