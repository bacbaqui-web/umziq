            ...
            {modifier.type === "mouth-basic" && (
              <label style={{ display: "inline-flex", alignItems: "center", gap: 5, color: "#9eabb5", fontSize: 10, whiteSpace: "nowrap" }}>
                ...
                <input
                  ...
                  onFocus={commands.focusMouthBasicRepetitions}
                  onChange={(event) => commands.changeMouthBasicRepetitions(event.target.value)}
                  onBlur={commands.blurMouthBasicRepetitions}
                  onKeyDown={(event) => {
                    if (commands.keyDownMouthBasicRepetitions(event.key) === "blur") {
