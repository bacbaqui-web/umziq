...
export default function TimelinePropertyTrackRow({ viewModel, contentWidth, interactions }: {
  ...
  const rowHeight = TIMELINE_PROPERTY_ROW_HEIGHT + 2;
  return (
    <div style={{ display: "contents" }}>
      <div style={{ gridColumn: 1, gridRow: viewModel.rowIndex, position: "relative", zIndex: 1, padding: "0 8px 0 4px", fontSize: 10, display: "flex", alignItems: "center", justifyContent: "flex-end", minWidth: 0, textAlign: "right", color: viewModel.selectedTimelineItem ? colors.label : colors.accentMuted, opacity: 0.95, overflow: "hidden", whiteSpace: "nowrap", textOverflow: "ellipsis", lineHeight: 1, height: rowHeight, backgroundColor: "transparent", border: "none", boxSizing: "border-box" }}>
      ...
      <div style={{ gridColumn: 2, gridRow: viewModel.rowIndex, position: "relative", zIndex: viewModel.dragging ? 50 : 2, width: contentWidth, minWidth: contentWidth, height: rowHeight, overflow: viewModel.dragging ? "visible" : "hidden", backgroundColor: "transparent", cursor: viewModel.dragging ? "none" : "default", border: "none", boxSizing: "border-box" }}>
