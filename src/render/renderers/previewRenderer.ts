...
import type { PreviewRendererResult } from "@/render/models/rendererResultModel";
...
function recordPlaybackPreviewUpdateMetrics(
  ...
  runtimeMetrics?.increment("previewDirtyNode", stats.dirtyNodeCount);
  runtimeMetrics?.increment("previewCleanNode", stats.cleanNodeCount);
  runtimeMetrics?.increment("previewNodeUpdated", stats.updatedNodeCount);
  runtimeMetrics?.increment("previewNodeReused", stats.reusedNodeCount);
