...
export default function LayerHoverPreviewCard({
  ...
  return (
    <div aria-hidden="true" style={{
      position: "fixed", zIndex, left: x, top: y, width: 110,
      ...
      <div style={{
        ...
        justifyContent: "space-between", gap: 4, overflow: "hidden",
        color: "#dce8f2", fontSize: 9,
      }}>
      ...
      <div style={{
        ...
        {hasVisual ? (
          imageUrl ? (
            <img src={imageUrl} alt="" style={{ display: "block", maxWidth: "100%", maxHeight: 100, objectFit: "contain" }} />
          ) : (
            <canvas
              ref={canvasRef}
          ...
          <span style={{ padding: "18px 6px", color: status === "missing" ? "#d99a9a" : "#aebbc6", fontSize: 9, fontWeight: 600 }}>
