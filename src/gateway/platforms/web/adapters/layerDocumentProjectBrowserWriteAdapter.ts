import type {
  WebProjectWriteEnvironment,
  WebProjectWritePort,
  WebProjectStorageErrorCode,
  WebProjectStorageResult,
  WebProjectWritableStream,
} from "@/gateway/platforms/web/webProjectStorageTypes";

function failure<T>(
  code: WebProjectStorageErrorCode,
  message: string
): WebProjectStorageResult<T> {
  return {
    ok: false,
    error: { code, message },
  };
