...
import { createModifierPropertiesController } from "@/engines/visual/controllers/modifierPropertiesController";
import { createPropertiesNumericDraftController } from "@/engines/visual/controllers/propertiesNumericDraftController";
import { createVisualPropertiesController } from "@/engines/visual/controllers/visualPropertiesController";
import { buildPropertiesDraftScopeIdentity } from "@/engines/visual/helpers/propertiesSelectionHelpers";
import type {
  LayerDocumentPropertiesCommandPort,
  LayerDocumentPropertiesReadContext,
} from "@/engines/visual/models/propertiesControllerModel";
import type { PropertiesDraftInputId } from "@/engines/visual/models/propertiesEngineModel";
